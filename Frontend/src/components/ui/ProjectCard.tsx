...
// GitHub SVG مباشرة لأن lucide-react لا تدعم brand logos
const GitHubIcon = () => (
...
export const ProjectCard = ({ title, description, githubLink, liveLink, technologies, imageUrl }: Project) => (
  <div className="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden hover:border-primary-500/40 hover:shadow-lg hover:shadow-primary-500/10 transition-all duration-300 group">
    {/* Image */}
    {imageUrl ? (
